...
export const winnersPageRouteName = 'Winners_Page';
FlowRouter.route('/winners', {
  name: winnersPageRouteName,
  action() {
    BlazeLayout.render('Winners_Layout', { main: winnersPageRouteName });
  },
});

/*                        NOMINATION ROUTE                       */

export const nominationPageRouteName = 'Nomination_Page';
FlowRouter.route('/nomination', {
  name: nominationPageRouteName,
  action() {
    BlazeLayout.render('Nomination_Layout', { main: nominationPageRouteName });
  },
});
